...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        results_stats_dic['n_correct_dogs'] += results_dic[key][3] and results_dic[key][4]
        results_stats_dic['n_correct_notdogs'] += (1 - results_dic[key][3]) and (1 - results_dic[key][4])
        results_stats_dic['n_correct_breed'] += results_dic[key][3] and results_dic[key][2] and results_dic[key][4]
